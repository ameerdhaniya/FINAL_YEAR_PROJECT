...
#importing dataset
dataset = pd.read_csv("/home/subhranil/Desktop/parkinson_dataset.csv")

#feature matrix creation
X = dataset.iloc[:, 6:22].values
...
def neural_net(lossfunc, bat_size, ep_size, OPTIMIZER):
    ...
    classifier.add(Dense(units = 100,kernel_initializer = 'normal',activation = 'relu',input_dim = 16))
    ...
    return history1,classifier,history2
...
train_history_mse , classifier , test_history_mse = neural_net('mean_squared_error',20,1000,ADAM)
...
best_model = load_model('/home/subhranil/Train_Models/weights-improvement-951-0.0055.hdf5')
